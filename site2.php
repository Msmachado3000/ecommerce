...
$app->get("/categories/:idcategory", function($idcategory) {
	...
	$paginations = $category->getProductsPage($page);

	$pages = [];

	for ($i=1; $i <= $paginations['pages']; $i++)
	{
...
$app->post("/profile", function(){
	...
	if (!isset($_POST['desperson']) || $_POST['desperson'] ==='') {
		User::setErro("Preencha o seu nome.");
		header("Location: /profile");
		exit;
	}

	if (!isset($_POST['desemail']) || $_POST['desemail'] ==='') {
		User::setErro("Preencha o seu e-mail.");
		header("Location: /profile");
		exit;
	}

	if (!isset($_POST['nrphone']) || $_POST['nrphone'] ==='') {
		User::setErro("Preencha o seu Telefone.");
		header("Location: /profile");
		exit;
	}
